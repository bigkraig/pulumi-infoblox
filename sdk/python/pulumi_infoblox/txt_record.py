...
class TXTRecord(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, comment=None, name=None, text=None, ttl=None, use_ttl=None, view=None, zone=None, __name__=None, __opts__=None):
        """
        ...
        super(TXTRecord, __self__).__init__(
            'infoblox:index/tXTRecord:TXTRecord',
            resource_name,
            __props__,
            opts)
