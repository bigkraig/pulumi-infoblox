...
class CNameRecord(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, canonical=None, comment=None, creator=None, ddns_principal=None, ddns_protected=None, disable=None, dns_name=None, forbid_reclamation=None, name=None, reclaimable=None, shared_record_group=None, ttl=None, use_ttl=None, view=None, __name__=None, __opts__=None):
        """
        ...
        super(CNameRecord, __self__).__init__(
            'infoblox:index/cNameRecord:CNameRecord',
            resource_name,
            __props__,
            opts)
