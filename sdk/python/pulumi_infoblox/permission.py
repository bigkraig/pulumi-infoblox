...
class Permission(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, group=None, object=None, permission=None, resource_type=None, role=None, __name__=None, __opts__=None):
        """
        ...
        super(Permission, __self__).__init__(
            'infoblox:index/permission:Permission',
            resource_name,
            __props__,
            opts)
